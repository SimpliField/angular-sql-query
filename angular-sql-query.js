(function() {
  ...
  function SqlQueryService($log, $q, sqlStorageService) {
    ...
    // Methods
    BackUp.prototype.getBackUp = getBackUp;
    BackUp.prototype.listBackUp = listBackUp;
    BackUp.prototype.queryBackUp = queryBackUp;
    BackUp.prototype.saveBackUp = saveBackUp;
    BackUp.prototype.updateBackUp = updateBackUp;
    BackUp.prototype.removeBackUp = removeBackUp;
    BackUp.prototype.bulkDocsBackUp = bulkDocsBackUp;
    BackUp.prototype.execute = execute;
